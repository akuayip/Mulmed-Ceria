"""
Menu Manager – versi Cindy (dirapikan & disusun ulang mirip style teman)
Menangani Main Menu, Credits, dan Guide Screen dengan background, scaling otomatis,
dan dukungan SoundManager.
"""
